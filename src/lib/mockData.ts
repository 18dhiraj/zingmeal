...
export const sampleMeals: Meal[] = [
  {
    ...
    pricing: {
      INR: 15,
      USD: Math.round(15 * 0.012),
      EUR: Math.round(15 * 0.011)
    },
    status: 1,
  ...
  },
  {
    ...
    pricing: {
      INR: 12,
      USD: Math.round(12 * 0.012),
      EUR: Math.round(12 * 0.011)
    },
    status: 1,
    dietaryTags: [],
    imageUrl: 'https://placehold.co/600x400.png',
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Classic Comfort:</h4>
        <p>This timeless sandwich is perfect for picnics and quick lunches. The combination of sweet grapes and savory chicken creates a delightful flavor balance.</p>
      </div>
    `
  },
  {
    ...
    pricing: {
      INR: 14,
      USD: Math.round(14 * 0.012),
      EUR: Math.round(14 * 0.011)
    },
    status: 1,
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Vegan Power:</h4>
        <p>This protein-packed stir-fry is full of plant-based goodness. The key to crispy tofu is pressing out the moisture first!</p>
      </div>
    `
  },
  {
    ...
    pricing: {
      INR: 18,
      USD: Math.round(18 * 0.012),
      EUR: Math.round(18 * 0.011)
    },
    status: 1,
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Fresh & Light:</h4>
        <p>This colorful pasta is bursting with seasonal vegetables. Feel free to add any of your favorite spring vegetables!</p>
      </div>
    `
  },
  {
    ...
    pricing: {
      INR: 22,
      USD: Math.round(22 * 0.012),
      EUR: Math.round(22 * 0.011)
    },
    status: 1,
  ...
  },
  {
    ...
    pricing: {
      INR: 8,
      USD: Math.round(8 * 0.012),
      EUR: Math.round(8 * 0.011)
    },
    status: 1,
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Perfect Start:</h4>
        <p>This parfait is not only delicious but also a nutritious way to start your day. The berries provide antioxidants while the granola adds satisfying crunch.</p>
      </div>
    `
  },
  {
    ...
    pricing: {
      INR: 9,
      USD: Math.round(9 * 0.012),
      EUR: Math.round(9 * 0.011)
    },
    status: 1,
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Comfort Food:</h4>
        <p>This hearty soup is packed with plant-based protein and warming spices. Perfect for a cozy evening meal!</p>
      </div>
    `
  },
  {
    ...
    pricing: {
      INR: 13,
      USD: Math.round(13 * 0.012),
      EUR: Math.round(13 * 0.011)
    },
    status: 1,
    dietaryTags: [],
    imageUrl: 'https://placehold.co/600x400.png',
    ...
    html: `
      <div>
        <h4 style="color: var(--primary); font-weight: bold;">Family Favorite:</h4>
        <p>These tacos are always a hit! Feel free to customize with your favorite toppings like jalapeños, salsa, or guacamole.</p>
      </div>
    `
  },
];
